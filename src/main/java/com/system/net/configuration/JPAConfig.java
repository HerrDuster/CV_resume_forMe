...
@EnableJpaRepositories("com.system.net.repository.storage")
public class JPAConfig {
    ...
    private Properties hibernateProperties(){
        ...
        properties.put("javax.persistemce.validation.mode", "none");
        return properties;
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(){
        ...
        entityManagerFactory.setPackagesToScan("com.system.net.entity");
